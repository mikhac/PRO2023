...
public class Functions {
    ...
    public static void main(String[] args) {
        ...
        Function<String, Integer> integerFromString = Integer::valueOf;
        System.out.println(integerFromString.apply("1"));
        integerFromString = integerFromString.andThen(x -> x + 1);
        System.out.println(integerFromString.apply("2"));
    }
}
